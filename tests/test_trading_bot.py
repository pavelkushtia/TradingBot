...
from trading_bot.core.models import MarketData, Quote, Order, Trade, Portfolio, StrategySignal
from trading_bot.core.exceptions import TradingBotError, RiskManagementError
...
class TestBacktestEngine:
    ...
    async def test_backtest_initialization(self, backtest_engine, config):
        ...
        assert backtest_engine.initial_capital == Decimal(str(config.trading.portfolio_value))
...
class TestRiskManagement:
    ...
    @pytest.mark.asyncio
    async def test_signal_evaluation(self, risk_manager, sample_signal, sample_portfolio):
    ...
    async def test_position_sizing(self, risk_manager, sample_portfolio):
        ...
        position_size = await risk_manager.calculate_position_size(symbol, price, sample_portfolio)
        ...
        max_position_value = sample_portfolio.total_value * Decimal(str(risk_manager.max_position_size))
