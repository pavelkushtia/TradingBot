...
class MomentumCrossoverStrategy(BaseStrategy):
    ...
    Generates buy signals when short-term moving average crosses above long-term moving average.
    Generates sell signals when short-term moving average crosses below long-term moving average.
    """
    ...
    async def _analyze_symbol(self, symbol: str) -> Optional[StrategySignal]:
        ...
        bars = self.get_bars(symbol, self.long_window + 5)  # Extra bars for confirmation
