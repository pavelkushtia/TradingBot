...
class BreakoutStrategy(BaseStrategy):
    ...
    def __init__(self, name: str, parameters: Dict[str, Any]):
        ...
        self.breakout_threshold = parameters.get("breakout_threshold", 0.02)  # 2% breakout
        self.volume_multiplier = parameters.get("volume_multiplier", 1.5)  # 1.5x average volume
    ...
    def _calculate_support_resistance(self, bars: List) -> tuple:
        ...
        resistance = highs_sorted[resistance_idx] if resistance_idx < len(highs_sorted) else resistance
        support = lows_sorted[support_idx] if support_idx < len(lows_sorted) else support
