...
class BaseStrategy(ABC):
    ...
    def calculate_ema(self, symbol: str, window: int, alpha: Optional[Decimal] = None) -> Optional[Decimal]:
    ...
    def calculate_bollinger_bands(self, symbol: str, window: int = 20, std_dev: int = 2) -> Optional[Dict[str, Decimal]]:
